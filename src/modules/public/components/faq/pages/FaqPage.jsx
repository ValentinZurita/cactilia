...
import { usePageContent } from '../../../../../hooks/usePageContent.js' // 2. Importar el hook genérico
  ...
  return (
    <div className="container py-5">
      ...
      <div className="text-center mb-5">
        ...
        {error &&
          <div className="alert alert-warning mt-3 d-inline-block">Error: {error}</div>} {/* Mostrar error si existe */}
      </div>
