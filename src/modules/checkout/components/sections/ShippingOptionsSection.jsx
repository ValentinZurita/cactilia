        ...
        <div className="checkout-section-content p-3 p-md-4 bg-white rounded border">
          ...
          {noValidOptionsError && (
            <div className="mt-3 p-3 border rounded bg-light">
              ...
              <p>Algunos productos en tu carrito tienen diferentes reglas de envío y la dirección seleccionada no es
                compatible con todas ellas.</p>
          ...
          <>
            ...
            {selectedOption && !shippingCoversAllProducts && (
              <div className="alert alert-danger mt-3">
                ...
                <strong>No se puede proceder con el pago</strong>: La opción de envío seleccionada no cubre todos los
                productos.
