...
import '@modules/checkout/styles/ShippingPackage.css' // <-- Restaurar la importación
import { PackageHeader } from '@modules/checkout/components/package/PackageHeader.jsx' // <-- Importar el nuevo componente
import { PackageSummary } from '@modules/checkout/components/package/PackageSummary.jsx' // <-- Importar PackageSummary
import { PackageDetailsList } from '@modules/checkout/components/package/PackageDetailsList.jsx' // <-- Importar PackageDetailsList
