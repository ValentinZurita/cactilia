...
export function SocialMediaEditor({ data = {}, onUpdate }) {
  ...
  // Asegura un array de items
  const socialItems = data.items || [];

  /** Inicia la edición de una red social */
  function startEditing(index) {
    setEditingIndex(index);
    setEditForm(socialItems[index]);
  }

  /** Guarda los cambios en la red social en edición */
  function saveEdit() {
  ...
  /** Alterna la visibilidad de un item */
        ...
        {showAddForm && (
          <div className="add-social-form mb-4 p-3 border rounded bg-light">
            ...
            <div className="mb-2">
              ...
              >Bootstrap Icons</a> (ej. <code>bi-facebook</code>, <code>bi-instagram</code>).
              </div>
            </div>
          ...
          socialItems.map((socialItem, index) => (
            <div
              ...
              className={`social-media-item mb-3 p-3 rounded border ${
                socialItem.visible === false ? 'bg-light' : 'bg-white'
              }`}
            >
              {/* Modo edición */}
              {editingIndex === index ? (
                ...
                <div>
                  <div className="d-flex align-items-center mb-2">
                    <i
                      className={`bi ${socialItem.icon} me-2 fs-4 ${
                        socialItem.visible === false ? 'text-muted' : ''
                      }`}
                    ></i>
                    <span
                      className={`fw-medium ${
                    ...
                    <div className="ms-auto d-flex">
                      ...
                      >
                        <i
                          className={`bi ${
                            socialItem.visible === false ? 'bi-eye' : 'bi-eye-slash'
                          }`}
                        ></i>
                      </button>
                      <button
                  ...
                  <div className="input-group">
                    <input
                      type="text"
                      className={`form-control ${
                        socialItem.visible === false ? 'bg-light text-muted' : 'bg-white'
                      }`}
